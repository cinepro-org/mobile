...
type Props = {
  ...
  /** Use backdrop image for cinematic 16:9 cards. */
  landscape?: boolean;
};

/** Large poster / landscape card with TV focus scale, glow, and elevation. */
export const TVFocusableCard = memo(function TVFocusableCard({
  item,
  width,
  height,
  onPress,
